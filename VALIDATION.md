...
| `tests/validation/test_nca_theoph_reference.py` | `TestPKNCACrossValidation::test_auclast_matches_pknca_per_subject` | Per-subject AUClast agrees with PKNCA 0.10.x within 2% relative tolerance (all 12 subjects) | Denney WS, Duvvuri S, Buckeridge CE (2015). J Stat Softw, 59(1), 1-21. DOI: 10.18637/jss.v059.i11 — PKNCA R package reference implementation |
| `tests/validation/test_nca_theoph_reference.py` | `TestPKNCACrossValidation::test_cmax_matches_pknca_per_subject` | Per-subject Cmax agrees with PKNCA 0.10.x within 2% relative tolerance (all 12 subjects) | Denney WS, Duvvuri S, Buckeridge CE (2015). J Stat Softw, 59(1), 1-21. DOI: 10.18637/jss.v059.i11 — PKNCA R package reference implementation |
