...
| `tests/validation/test_be_power_reference.py` | `TestPowerTOSTCrossValidation::test_power_approaches_one_as_n_grows_for_gmr_one`, `test_power_equals_alpha_at_boundary_gmr`, `test_power_increases_with_n`, `test_power_decreases_with_higher_cv`, `test_sample_size_decreases_as_cv_decreases`, `test_sample_size_higher_for_gmr_farther_from_one`, `test_power_raises_on_invalid_gmr`, `test_power_raises_on_invalid_cv`, `test_power_raises_on_small_n`, `test_sample_size_raises_on_invalid_target_power`, `test_power_is_between_zero_and_one` | Degenerate properties: power -> 1.0 as n grows (GMR=1.0), power = alpha at acceptance boundary, power increases with n and decreases with CV, sample size decreases with lower CV, input validation on all parameters | Degenerate sanity checks (by definition); Phillips KF (1990) J Pharmacokinet Biopharm 18(2):137-144; Diletti E et al. (1991) Int J Clin Pharmacol Ther Toxicol 29(1):1-8 |
